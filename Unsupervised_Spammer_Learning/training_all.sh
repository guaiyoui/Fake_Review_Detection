...
# nohup python link_pretrain.py --dataset spammer --model_name spammer --alpha 0.01 --epochs 300 --batch_size 9424 --dropout 0.1 --hidden_dim 512 --hops 5  --n_heads 8 --n_layers 2 --pe_dim 10 --peak_lr 0.001  --weight_decay=1e-05 --device 5 >> ./logs/spammer_training.txt 2>&1 &

python link_pretrain.py --dataset spammer --model_name spammer --epochs 300 --batch_size 9424 --dropout 0.1 --hidden_dim 128 --hops 5  --n_heads 8 --n_layers 2 --pe_dim 10 --peak_lr 0.001  --weight_decay=1e-05 --device 5